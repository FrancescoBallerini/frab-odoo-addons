odoo.define('form_dialog_button_click_keep_open.action_manager_patch', function (require) {
"use strict";
...
ActionManager.include({
    ...
    _onExecuteAction: function (ev) {
        if (_.has(ev.data, 'action_data') && _.has(ev.data.action_data, 'keep_dialog_active')){
    ...
    _handleAction: function (action, options) {
        ...
        if (!_.isEmpty(this.keep_dialog_active) &&
            this.keep_dialog_active.additionalData.selector_mode === 'o_btn_keep_open') {
    ...
    _executeCloseAction: function (action, options) {
        ...
        return this._super.apply(this, arguments).then(function () {
            if (!_.isEmpty(self.keep_dialog_active) &&
                self.keep_dialog_active.additionalData.selector_mode === 'o_btn_reopen') {
